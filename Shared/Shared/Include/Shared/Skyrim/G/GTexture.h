...
namespace Skyrim
{
	...
	public:
		...
		// Add
		virtual ~GTexture() {}                                                                                                                                                                                                                                            // 0
		virtual bool         InitializeTexture(GImageBase* imageBase, Utility::Enumeration<ImageTextureUsage, std::uint32_t> imageTextureUsage = ImageTextureUsage::kWrap)                                                                                           = 0; // 1
		virtual bool         InitializeDynamicTexture(std::int32_t width, std::int32_t height, Utility::Enumeration<GImage::ImageFormat, std::uint32_t> imageFormat, std::int32_t mipMaps, Utility::Enumeration<ImageTextureUsage, std::uint32_t> imageTextureUsage) = 0; // 2
		virtual void         Update(std::int32_t level, std::int32_t count, const UpdateRectangle* updateRectangles, const GImageBase* imageBase)                                                                                                                    = 0; // 3
		virtual std::int32_t Map(std::int32_t level, std::int32_t count, MapRectangle* mapRectangles, Utility::Enumeration<MapFlags, std::uint32_t> mapFlags = MapFlags::kNone)                                                                                      = 0; // 4
		virtual bool         Unmap(std::int32_t level, std::int32_t count, MapRectangle* mapRectangles, Utility::Enumeration<MapFlags, std::uint32_t> mapFlags = MapFlags::kNone)                                                                                    = 0; // 5
		...
		virtual void         AddChangeHandler(ChangeHandler* changeHandler)                                                                                                                                                                                          = 0; // A
		virtual void         RemoveChangeHandler(ChangeHandler* changeHandler)                                                                                                                                                                                       = 0; // B
