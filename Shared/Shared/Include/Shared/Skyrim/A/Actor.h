...
namespace Skyrim
{
	...
	public:
		...
		virtual ObjectReferenceHandle RemoveBoundObject(TESBoundObject* boundObject, std::uint32_t boundObjectCount, Utility::Enumeration<ItemRemoveReason, std::uint32_t> itemRemoveReason, ExtraDataList* extraDataList, TESObjectREFR* moveToReference, const NiPoint3* position, const NiPoint3* rotation) override; // 56
		...
		virtual EventNotifyControl ProcessEvent(const BSTransformDeltaEvent* eventArguments, BSTEventSource<BSTransformDeltaEvent>* eventSource) override; // 1

		// Override (BSTEventSink<bhkCharacterMoveFinishEvent>)
		virtual EventNotifyControl ProcessEvent(const bhkCharacterMoveFinishEvent* eventArguments, BSTEventSource<bhkCharacterMoveFinishEvent>* eventSource) override; // 1
		...
		virtual ObjectReferenceHandle DropBoundObject(TESBoundObject* boundObject, ExtraDataList* extraDataList, std::uint32_t boundObjectCount, const NiPoint3* position, const NiPoint3* rotation); // CB
		...
		ActorMagicCaster*                                 magicCasters[Utility::Conversion::ToUnderlying(SlotType::kTotal)];       // 1A0, 1A8
		MagicItem*                                        selectedMagicItems[Utility::Conversion::ToUnderlying(SlotType::kTotal)]; // 1C0, 1C8
