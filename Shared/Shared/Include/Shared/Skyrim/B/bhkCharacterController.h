...
namespace Skyrim
{
	...
	public:
		...
		bhkICharOrientationController*                             characterOrientationController; // 190
		...
		Utility::Enumeration<hkpCharacterStateType, std::uint32_t> desiredCharacterStateType;      // 21C
	...
	static_assert(offsetof(bhkCharacterController, characterOrientationController) == 0x190);
	static_assert(offsetof(bhkCharacterController, surfaceInformation) == 0x1A0);
	static_assert(offsetof(bhkCharacterController, characterContext) == 0x1E0);
	static_assert(offsetof(bhkCharacterController, characterControllerFlags) == 0x218);
	static_assert(offsetof(bhkCharacterController, desiredCharacterStateType) == 0x21C);
