...
namespace Skyrim
{
	...
	public:
		...
		virtual ObjectReferenceHandle             RemoveBoundObject(TESBoundObject* boundObject, std::uint32_t boundObjectCount, Utility::Enumeration<ItemRemoveReason, std::uint32_t> itemRemoveReason, ExtraDataList* extraDataList, TESObjectREFR* moveToReference, const NiPoint3* position, const NiPoint3* rotation); // 56
