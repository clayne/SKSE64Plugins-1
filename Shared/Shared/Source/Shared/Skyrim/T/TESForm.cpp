...
namespace Skyrim
{
	...
	{
		auto* function{ reinterpret_cast<decltype(TESForm::GetFormFromEditorID)*>(
			Addresses::TESForm::GetFormFromEditorID()) };
	...
	{
		auto* function{ reinterpret_cast<
			Utility::TypeTraits::MakeFunctionPointer<decltype(&TESForm::GetFormName)>::type>(
			Addresses::TESForm::GetFormName()) };
	...
	{
		auto* function{ reinterpret_cast<
			Utility::TypeTraits::MakeFunctionPointer<decltype(&TESForm::GetMaximumCharge)>::type>(
			Addresses::TESForm::GetMaximumCharge()) };
	...
	{
		auto* function{ reinterpret_cast<
			Utility::TypeTraits::MakeFunctionPointer<decltype(&TESForm::SetTemporary)>::type>(
			Addresses::TESForm::SetTemporary()) };
